...
# 【新增】政府行政與財務雜訊過濾
GOV_ADMIN_KEYWORDS = ["會計月報", "決算", "預算", "招標", "決標", "採購公告", "歲出", "歲入", "財務報表", "人事異動"]

# 組合所有黑名單字典以便快速掃描
ALL_BLACKLIST = EXCLUDE_KEYWORDS + COURSE_KEYWORDS + CONSUMER_KEYWORDS + GOSSIP_KEYWORDS + PR_KEYWORDS + GOV_ADMIN_KEYWORDS
